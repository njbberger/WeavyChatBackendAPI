...
namespace WeavyChat.Entities
{
    public class Conversation
    {
        ...
        public class InputGetConversation 
        {
            public int id { get; set; } //Id of the conversation to return
            public bool trashed { get; set; } //true to return conversation even if trashed, otherwise false
        }

        public class OutputGetConversation
        {
